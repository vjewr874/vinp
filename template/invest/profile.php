                ...
                <div class="container-fluid">
                    ...
                    <div class="partners">
                        ...
                        <div class="row mb-30-none">
                                ...
                                <div class="create_wrapper mw-100">
                                    ...
                                    <form class="create_ticket_form row mb-30-none">
                                        ...
                                        <div class="create_form_group col-sm-12">
                                            ...
                                            <input type="text" readonly id="username" value="<?php echo $cus->cus_fullname;?>" placeholder="Họ và tên">
                                        </div>
                                        <div class="create_form_group col-sm-12">
                                        ...
                                        <div class="create_form_group col-sm-12">
                                            ...
                                            <input type="text" <?php echo ($cus->cus_update_flag == 1)? "readonly" : ""; ?> id="account_address" value="<?php echo $cus->cus_address;?>" placeholder="Địa chỉ">
                                        </div>
										<?php if($cus->cus_update_flag == 0)
										{
										?>
							...
							?>
                            <div class="col-lg-6 mb-30" style="display: none;">
                                <div class="create_wrapper mw-100">
                                    ...
                                    <form class="create_ticket_form row mb-30-none">
										...
										else
										{
											...
											<div class="create_form_group col-sm-12">
												...
												<input type="text" <?php echo ($bankupdate)? "readonly" : ""; ?> id="bank_name" value="<?php echo $banklist->bank_name; ?>">
											</div>
											<?php
										}
										?>
                                        ...
                                        <div class="create_form_group col-sm-12">
                                            ...
                                            <input type="text" <?php echo ($bankupdate)? "readonly" : ""; ?> id="bank_account" value="<?php echo $banklist->bank_account; ?>">
                                        </div>
                                        <div class="create_form_group col-sm-12">
                                            <label for="bank_holder">Chủ tài khoản:</label>
                                            <input type="text" <?php echo ($bankupdate)? "readonly" : ""; ?> id="bank_holder" value="<?php echo $banklist->bank_holder; ?>">
                                        </div>
                                        <div class="create_form_group col-sm-12">
                                            <label for="bank_branch">Chi nhánh:</label>
                                            <input type="text" <?php echo ($bankupdate)? "readonly" : ""; ?> id="bank_branch" value="<?php echo $banklist->bank_branch; ?>">
                                        </div>
                                        <div class="create_form_group col-sm-12">
                                            <label for="litecoin_account">Loại tiền:</label>
                                            <input type="text" <?php echo ($bankupdate)? "readonly" : ""; ?> id="bank_currency" readonly value="Việt Nam Đồng">
                                        </div>
                                        <?php if(!$bankupdate)
										{
										?>
