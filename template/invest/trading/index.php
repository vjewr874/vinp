		...
		<section class="lightBox">
			...
			<div class="lightBox-body">
				...
				<div class="lightBox-panel" id="boxNotice">
					<div class="lightBox-icon"> <span class="icon-times"></span></div>
					<div class="lightBox-title">Thông báo bảo trì</div>
					<div class="lightBox-content">
						<p>Chúng tôi đang thực hiện bảo trì nhằm nâng cấp hệ thống giao dịch. Xin vui lòng quay lại sau 21:00 28/01/2022 GMT+7. Xin cáo lỗi và chân thành cảm ơn!</p>
						<div class="btn-group">
							<button class="btn-confirm" onclick="lightBoxClose()">OK</button>
						</div>
					</div>
