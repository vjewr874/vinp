                        ...
                        <div class="col-lg-6">
                            <div class="total-earning-item">
                                <div class="total-earning-heading">
                                    ...
                                    <h4 class="amount cl-1"><?php echo number_format(rand(399999999,500000000),0);?> VNĐ</h4>
                                </div>
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="item">
                                        <div class="cont">
                                            <h4 class="cl-theme">+<?php echo number_format(rand(120,240),0);?>%</h4>
                                    ...
                                    <div class="item">
                                        <div class="cont">
                                            <h4 class="cl-1">+<?php echo number_format(rand(120,240),0);?>%</h4>
						...
						<div class="col-lg-6">
                            <div class="earn-item mb-30">
                                ...
                                <div class="earn-content partner-content d-flex flex-wrap align-items-start justify-content-between">
                                    ...
                                    <ul class="mb--5">
										<?php
										$register = rand(700000,732000);
										$active = rand(600000,700000);
										?>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="cont">
                                                ...
                                                <span class="cl-1"><?php echo number_format($register,0);?></span>
                                            </div>
                                        </li>
										<li>
                                            <div class="icon">
                                            ...
                                            <div class="cont">
                                                ...
                                                <span class="cl-1"><?php echo number_format($active,0);?></span>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="cont">
                                                ...
                                                <span class="cl-1"><?php echo number_format(($register - $active),0);?></span>
                                            </div>
                                        </li>
										<li>
                                            <div class="icon">
                                            ...
                                            <div class="cont">
                                                ...
                                                <span class="cl-1 amount"><?php echo number_format(rand(100,300),0);?></span>
                                            </div>
                                        </li>
                                    </ul>
                                    <div class="total-partner">
                                        <span class="total-title"><?php echo number_format($register,0);?></span>
                                        <span>Tổng</span>
                                    </div>
                                </div>
                            </div>
