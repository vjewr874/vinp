...
<head>
    ...
    <!-- plugin css file  -->
    <link rel="stylesheet" href="<?php echo $template_path; ?>/assets/plugin/datatables/responsive.dataTables.min.css">
    <link rel="stylesheet" href="<?php echo $template_path; ?>/assets/plugin/datatables/dataTables.bootstrap5.min.css"> 
    
    <!-- project css file  -->
    <link rel="stylesheet" href="<?php echo $template_path; ?>/assets/css/cryptoon.style.min.css">
</head>
<body>
        ...
        <div class="sidebar py-2 py-md-2 me-0 border-end">
            <div class="d-flex flex-column h-100">
                ...
                <ul class="menu-list flex-grow-1 mt-4 px-1">
                    ...
                    <li>
                        <a class="m-link" href="exchange.html">
                            <svg xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="24px" height="24px" viewBox="0 0 38 38">
                    ...
                    <div class="container-xxl">
                        ...
                        <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                                                ...
                                                <ul class="list-unstyled list mb-0">
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="<?php echo $template_path; ?>/assets/images/xs/avatar1.svg" alt="">
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="<?php echo $template_path; ?>/assets/images/xs/avatar3.svg" alt="">
                                                            <div class="flex-fill ms-2">
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="<?php echo $template_path; ?>/assets/images/xs/avatar5.svg" alt="">
                                                            <div class="flex-fill ms-2">
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="<?php echo $template_path; ?>/assets/images/xs/avatar6.svg" alt="">
                                                            <div class="flex-fill ms-2">
                                                    ...
                                                    <li class="py-2">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="<?php echo $template_path; ?>/assets/images/xs/avatar7.svg" alt="">
                                                            <div class="flex-fill ms-2">
                            ...
                            <div class="dropdown zindex-popover">
                                <a class="nav-link dropdown-toggle pulse" href="#" role="button" data-bs-toggle="dropdown">
                                    <img src="<?php echo $template_path; ?>/assets/images/flag/GB.png" alt="">
                                </a>
                                <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-md-end p-0 m-0">
                                    <div class="card border-0">
                                        <ul class="list-unstyled py-2 px-3">
                                            <li>
                                                <a href="#" class=""><img src="<?php echo $template_path; ?>/assets/images/flag/GB.png" alt=""> English</a>
                                            </li>
                                            <li>
                                                <a href="#" class=""><img src="<?php echo $template_path; ?>/assets/images/flag/DE.png" alt=""> German</a>
                                            </li>
                                            <li>
                                                <a href="#" class=""><img src="<?php echo $template_path; ?>/assets/images/flag/FR.png" alt=""> French</a>
                                            </li>
                                            <li>
                                                <a href="#" class=""><img src="<?php echo $template_path; ?>/assets/images/flag/IT.png" alt=""> Italian</a>
                                            </li>
                                            <li>
                                                <a href="#" class=""><img src="<?php echo $template_path; ?>/assets/images/flag/RU.png" alt=""> Russian</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                                <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static">
                                    <img class="avatar lg rounded-circle img-thumbnail" src="<?php echo $template_path; ?>/assets/images/profile_av.svg" alt="profile">
                                </a>
                                <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                    <div class="card border-0 w280">
                                        <div class="card-body pb-0">
                                            <div class="d-flex py-1">
                                                <img class="avatar rounded-circle" src="<?php echo $template_path; ?>/assets/images/profile_av.svg" alt="profile">
                                ...
                                <div class="card-body p-3">
                                    <div class="row g-3">
                                        <div class="d-none d-lg-block col-lg-2 text-start">
                                            ...
                                            <img src="<?php echo $template_path; ?>/assets/images/qr-code.png" alt="Download App" class="img-fluid">
                                        </div>
                                        <div class="col-lg-10">
                                            ...
                                            <div class="security border-bottom">
                                                <div class="d-flex align-items-start px-2 py-3">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <a href="security.html" title="setup" class="text-decoration-underline">Turn on</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <table id="ordertabthree" class="priceTable table table-hover custom-table-2 table-bordered align-middle mb-0" style="width:100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><img src="<?php echo $template_path; ?>/assets/images/coin/ETH.png" alt="" class="img-fluid avatar mx-1">ETH/USDT</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="<?php echo $template_path; ?>/assets/images/coin/SOL.png" alt="" class="img-fluid avatar mx-1">SOL/USDT</td>
                                                <td><span class="color-price-down">Sell</span></td>
                                                <td>160.33</td>
                                                <td>0.75</td>
    ...
    <!-- Jquery Core Js -->
    <script src="<?php echo $template_path; ?>/assets/bundles/libscripts.bundle.js"></script>

    <!-- Plugin Js -->
    <script src="<?php echo $template_path; ?>/assets/bundles/dataTables.bundle.js"></script>
    <script src="<?php echo $template_path; ?>/assets/bundles/apexcharts.bundle.js"></script>

    <!-- Jquery Page Js -->
    <script src="<?php echo $template_path; ?>/assets/js/template.js"></script>
    <script src="<?php echo $template_path; ?>/assets/js/page/index.js"></script>
</body>
