		...
		$(document).ready(function() {
			...
			*/
			$("#bettingrecorddata").on("click",function()
			{
				...
				$.ajax({
					type: "POST",
					url: "http://lightning.vcfmedia.com/api/searchlistbet",
			...
			setInterval(function() {
				...
				$.ajax({
					type: "POST",
					url: "http://lightning.vcfmedia.com/api/getlistbet",
					data: {},
					dataType: "json",
					cache: false,
					success: function(data)
			...
			setInterval(function() {
				...
				$.ajax({
					type: "POST",
					url: "http://lightning.vcfmedia.com/api/checktoken",
					data: {token: auth},
					dataType: "json",
					cache: false,
					success: function(data)
	...
	<div class="master-frame">
		<div class="container-fluid">
			...
			<div class="choice-list">
				...
				<!-- <div class="frame-title"><img src="<?php echo $template_path; ?>/trading/images/online.gif"> Kim loại quý</div> -->
				<div class="choice-section2">
					<div class="choices item">
						<div class="list-item">
							<div class="list-item-name">--/--</div>
							<div class="item-section2">
											...
											<div class="wrapup">
												<form id="Game_form" class="bet-2"
															...
															<div class="radio-group">
																<div class="choose-radio radio-buyup">
																	...
																	<label for="binary_playType_A"
																		style="border-radius: 10px 0 0 10px;">Lên<br><span
																...
																<div class="choose-radio radio-buydown">
																	...
																	<label for="binary_playType_B"
																		style="border-radius: 0 10px 10px 0;">Xuống<br><span
																			class="bet1">90%</span></label>
																</div>
																<div class="choose-radio odd_even_color">
													...
													<div class="bet-inforight">
														<div class="wallet-frame">
															Ví tiền: <span id="wallets" ckt-name="balance"><?php echo number_format($cus->acc_balance,0);?></span>
														</div>
...
<script src="<?php echo $template_path; ?>/trading/js/scripts.js"></script>
<script src="<?php echo $template_path; ?>/trading/js/config.js"></script>
<script src="<?php echo $template_path; ?>/trading/js/localize.js"></script>
<script src="<?php echo $template_path; ?>/trading/js/utils.js"></script>
<script src="<?php echo $template_path; ?>/trading/js/msgpack.js"></script>
<script src="<?php echo $template_path; ?>/trading/js/websocket.js"></script>
<script src="<?php echo $template_path; ?>/trading/js/message.js"></script>
<script src="<?php echo $template_path; ?>/trading/js/ErrorType.js"></script>
<script src="<?php echo $template_path; ?>/trading/js/MessageType.js"></script>
<script src="<?php echo $template_path; ?>/trading/js/gameDatas.js"></script>
<script src="<?php echo $template_path; ?>/trading/js/_common.js"></script>
