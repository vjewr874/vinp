                ...
                <div class="site-header-container">
                    ...
                    <ul class="dashboard-menu">
                        ...
                        <li class="trade-menu-mobile">
                            <a href="<?php echo XC_URL; ?>/trading?game=700&auth=<?php echo $this->config->_config("auth");?>&token=<?php echo $_SESSION['token'];?>" class="<?php echo ($page["key"] == "trading")? "active" : "";?>" target="_blank"><i class="flaticon-globe"></i>Giao dịch</a>
                        </li>
                        <li class="trade-menu-desktop">
                            <a href="<?php echo XC_URL;?>/giao-dich.html" class="<?php echo ($page["key"] == "trading")? "active" : "";?>"><i class="flaticon-globe"></i>Giao dịch</a>
                        </li>
						<li>
                                    ...
                                    <ul class="dashboard-right-menus">
                                        ...
                                        <li>
                                            <a href="#0" class="author">
                                                ...
                                                <div class="content">
                                                    <h6 class="title"><?php echo $cus->cus_fullname;?></h6>
