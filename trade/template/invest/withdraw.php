                ...
                <div class="container-fluid">
                    ...
                    <div class="deposit">
                        ...
                        <div class="deposit-system">
                            <h4 class="main-subtitle">01. Chọn tài khoản rút tiền</h4>
                            <div class="text-center deposit-method-slider owl-theme owl-carousel">
								...
								{
								?>
                                <a href="#" data-id="<?php echo $b->cbid;?>" class="deposit-method-item">
                                    <div class="thumb">
                                        <div class="check">
                                            <img src="<?php echo $template_path; ?>/assets/images/dashboard/payment/check.png" alt="<?php echo $b->bank_name;?>">
                                        </div>
                                        <img src="<?php echo $upload_path; ?>/banks/<?php echo $b->bank_logo;?>" class="deposit-img" alt="<?php echo $b->bank_name;?>">
                                    </div>
                                </a>
								<?php
								$i++;
								...
								?>
								<input type="hidden" id="countbank" value="<?php echo $i;?>">
                                <input type="hidden" id="method" value="">
                            </div>
                        </div>
                        <div class="deposit-system">
                            <h4 class="main-subtitle">02. Nhập số tiền muốn rút:</h4>
							<div class="form-group">
									<label class="mr-sm-2"><small class="text-muted">Lưu ý: Số tiền giá trị tối thiểu của một lần rút là <b><?php echo number_format($this->config->_config("minimun_withdraw"),0);?> VNĐ</b>. Việc rút tiền yêu cầu phí xử lí là <?php echo $this->config->_config("withdraw_fee");?>% trên tổng số tiền rút</small></label>
								</div>
                            <form class="make-deposit">
								
                                <div class="form-group">
                                    <input type="number" step="100000" min="<?php echo $this->config->_config("minimun_withdraw");?>" placeholder="Nhập số tiền muốn rút" id="withdrawel_amount" class="make-amount">
									<div class="d-flex justify-content-between mt-3">
										<p class="mb-0">Phí rút tiền:</p>
										<h6 class="mb-0" id="withdrawel_fee"></h6>
									</div>
                                </div>
                                <div class="form-group">
                                    <label for="total-profit">Số tiền nhận</label>
                                ...
                                <div class="form-group">
                                    <button type="button" id="btn-withdraw" class="custom-button border-0">Tạo yêu cầu</button>
                                </div>
                            </form>
							<div class="d-flex align-items-center mb-30">
                                        <div class="update_user">
										
                                            <img src="<?php echo $template_path.'/assets/images/dashboard/user.png'; ?>" alt="dashboard">
                                        </div>
                                        <div class="pl-3">
                                            <span class="sub_subtitle cl-title fz-sm d-block">Mặt trước CMND</span>
									...
									<div class="d-flex align-items-center mb-30">
                                        ...
                                        <div class="pl-3">
                                            <span class="sub_subtitle cl-title fz-sm d-block">Mặt sau CMND</span>
                                            <label for="update_profile" class="custom-button m-0 mt-2 lh-40 h-40">Chọn ảnh</label>
                                            <input type="file" id="update_profile" class="profile_update_input">
                                        </div>
                                    </div>
