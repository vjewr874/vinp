...
var BetData = function() {
  ...
  , UserBetRequest = function() {
    this.draw_lottery_id = this.room_id = 1;
    this.bet_data_list
};
...
var DrawLotteryLogData = function() {
    this.id = 1;
    this.draw_lottery_content = this.draw_lottery_time = this.expected_draw_time = this.draw_lottery_num = ""
}
  , GetDrawLotteryHistoryRequest = function() {
    this.room_id = 1;
    this.count = 5
};
...
var GetBinaryPriceInfoRequest = function() {
    this.count = this.group_id = this.room_id = 0
};
