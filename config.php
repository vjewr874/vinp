...
{
/*** define Theme ***/
	define('ThemeMaster', 'v2'); //Replace xpanel by your theme's name
}
else
{
...
/*** define site path ***/
if($username == "linkfb" || $username == "www" )
{
	define('XC_URL','https://linkfb.co');
}
else
{
	$_SESSION['sub'] = $username;
	define('XC_URL','https://'.$username.'.linkfb.co');
}

define('TRADE_URL','https://trading.linkfb.co');
define('REF_ID',0);
$siteurl = XC_URL;
/*** template path ***/
